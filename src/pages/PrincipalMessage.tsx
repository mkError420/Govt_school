        ...
        <div className="lg:w-1/3">
          <div className="gov-box sticky top-24">
             ...
             <div className="p-6 text-center bg-gray-50">
                <h3 className="text-xl font-black text-primary mb-1">মোসাম্মৎ রোকেয়া বেগম</h3>
                <p className="text-[12px] font-black text-gray-500 uppercase tracking-widest mb-4">প্রধান শিক্ষিকা</p>
                ...
                <div className="space-y-2 text-left border-t border-gray-200 pt-4">
                  <div className="flex items-center gap-3 text-[11px] font-bold text-gray-600">
                    <GraduationCap className="w-4 h-4 text-secondary" /> <span>এম.এ, বি.এড (১ম শ্রেণী)</span>
                  </div>
                  <div className="flex items-center gap-3 text-[11px] font-bold text-gray-600">
                    <Award className="w-4 h-4 text-secondary" /> <span>বিসিএস (সাধারণ শিক্ষা)</span>
                  </div>
                  <div className="flex items-center gap-3 text-[11px] font-bold text-gray-600">
                    <Mail className="w-4 h-4 text-secondary" /> <span>rokeya.head@example.edu.bd</span>
                  </div>
                </div>
             </div>
          </div>
            ...
            <div className="relative z-10 space-y-6 text-justify text-[13px] leading-relaxed text-gray-700 font-medium">
              ...
              <div className="pt-8 border-t border-gray-100 flex flex-col items-end">
                <div className="text-right">
                  <p className="font-black text-gray-800">মোসাম্মৎ রোকেয়া বেগম</p>
                  <p className="text-[11px] font-bold text-gray-500 uppercase">প্রধান শিক্ষিকা</p>
